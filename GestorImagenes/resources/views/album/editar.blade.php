        ...
        <div class="w-full max-w-lg">
            <div class="bg-white rounded-lg shadow">
                ...
                <div class="bg-gray-50 border-b border-gray-200 px-6 py-4 rounded-t-lg">
                    <h2 class="text-lg font-semibold text-gray-800">Editar Álbum</h2>
                </div>
                    ...
                    <form method="POST" action="{{ route('albums.update', $album->id) }}">
                        ...
                        <div class="mb-6">
                            ...
                            <textarea id="album_descripcion" name="album_descripcion" rows="3"
                                class="w-full border border-gray-300 rounded px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500
                                @error('album_descripcion') border-red-500 @enderror">{{ old('album_descripcion', $album->album_descripcion) }}</textarea>
