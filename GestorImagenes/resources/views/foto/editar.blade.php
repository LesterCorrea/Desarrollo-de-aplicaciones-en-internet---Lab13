        ...
        <div class="w-full max-w-lg">
            <div class="bg-white rounded-lg shadow">
                ...
                <div class="bg-gray-50 border-b border-gray-200 px-6 py-4 rounded-t-lg">
                    <h2 class="text-lg font-semibold text-gray-800">Editar Foto</h2>
                </div>

                <div class="px-6 py-6">
                    <form method="POST" action="{{ route('fotos.update') }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-4">
                            ...
                            <input id="foto_nombre" type="text" name="foto_nombre"
                                value="{{ old('foto_nombre', $foto->foto_nombre) }}" required autofocus
                        ...
                        <div class="mb-4">
                            ...
                            <textarea id="foto_descripcion" name="foto_descripcion" rows="2"
                                class="w-full border border-gray-300 rounded px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500">{{ old('foto_descripcion', $foto->foto_descripcion) }}</textarea>
                        </div>
                        ...
                        <div class="flex justify-between">
                            ...
                            <button type="submit"
                                class="bg-green-600 hover:bg-green-700 text-white text-sm font-semibold px-5 py-2 rounded transition">
                                Actualizar
                            </button>
                        </div>
